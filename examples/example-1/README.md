...
In the first example, we use UltraCold to study the ground state and a simple dynamics of a
...
$\omega_{breathing}=\sqrt{5}\omega_{ho}$ </a>. The breathing oscillation can be excited, for example, via a sudden
