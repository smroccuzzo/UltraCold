...
namespace UltraCold {
                                      ...
                                      Vector<double> &kx)
    {
        ...
        if (nx != nkx)
        {
            std::cout
                    << "\n\n"
                    << "********************************************************************\n"
                    << "Error while trying to create a 1-dimensional mesh in Fourier space. \n"
                    << "The dimensions of the Vectors x and kx provided are not equal.\n"
        ...
        else
        {
            ...
            // Dimensions are fine, generate the kx axis
                                      ...
                                      Vector<double> &ky)
    {
        ...
        if (nx != nkx || ny != nky)
        {
            std::cout
                    << "\n\n"
                    << "***************************************************************************\n"
                    << "Error while trying to create a 2-dimensional mesh in Fourier space.        \n"
                    << "The dimensions of the Vectors x and kx or y and ky provided are not equal. \n"
                    << "Terminating program now...\n"
                    << "***************************************************************************\n"
                    << "\n\n"
                    <<
                                      ...
                                      Vector<double> &kx, Vector<double> &ky, Vector<double> &kz)
    {
        ...
        if (nx != nkx || ny != nky || nz != nkz)
        {
            std::cout
                    << "\n\n"
                    << "***************************************************************************************\n"
                    << "Error while trying to create a 3-dimensional mesh in Fourier space.                    \n"
                    << "The dimensions of the Vectors x and kx or y and ky or z and kz provided are not equal. \n"
                    << "Terminating program now...\n"
                    << "***************************************************************************************\n"
                    << "\n\n"
                    <<
