...
namespace UltraCold
{
    namespace BogolyubovSolvers
    {
                                                         ...
                                                         bool eigenvectors_required)
        {
            ...
            ny = 0;
            nz = 0;
            if(psi0.extent(0) != nx || this->Vext.extent(0) != nx)
            {
                std::cout
                        << "\n\n"
                        << "***************************************************************************\n"
                        << "Error found in the constructor of a TrappedBogolyubovSolver for Bogolyubov  "
                        << "equations in one space dimension. The dimensions of the Vectors provided as\n"
                                                         ...
                                                         bool eigenvectors_required)
        {
            ...
            nz = 0;
            if(psi0.extent(0) != nx || this->Vext.extent(0) != nx ||
               psi0.extent(1) != ny || this->Vext.extent(1) != ny)
            {
                std::cout
                        << "\n\n"
                        << "****************************************************************************\n"
                        << "Error found in the constructor of a TrappedBogolyubovSolver for Bogolyubov  "
                        << "equations in two space dimensions. The dimensions of the Vectors provided as\n"
                        << "input are not consistent.\n"
                        << "Terminating the program now...\n"
                        << "****************************************************************************\n"
                        << "\n\n"
                                                         ...
                                                         bool eigenvectors_required)
        {
            ...
            if(psi0.extent(0) != nx || this->Vext.extent(0) != nx ||
               psi0.extent(1) != ny || this->Vext.extent(1) != ny ||
               psi0.extent(2) != nz || this->Vext.extent(2) != nz )
            {
                std::cout
                        << "\n\n"
                        << "******************************************************************************\n"
                        << "Error found in the constructor of a TrappedBogolyubovSolver for Bogolyubov  "
                        << "equations in three space dimensions. The dimensions of the Vectors provided as\n"
                        << "input are not consistent.\n"
                        << "Terminating the program now...\n"
                        << "******************************************************************************\n"
                        << "\n\n"
